...
public class AccountMapper {
    ...
    public static AccountWithCustomers mapAccountToDoWithCustomers(Account account, AccountWithCustomers accountWithCustomers) {
        accountWithCustomers.setAccountNumber(account.getAccountNumber());
        accountWithCustomers.setAccountType(account.getAccountType());
        accountWithCustomers.setCustomerId(account.getCustomerId());
        accountWithCustomers.setBranch(account.getBranch());
        accountWithCustomers.setBalance(account.getBalance());
